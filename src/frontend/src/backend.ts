...
import type { ChunkInfo as _ChunkInfo, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async finalizeUpload(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getChunkInfo(arg0: string): Promise<ChunkInfo | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getChunkInfo(arg0);
    ...
    async getFileChunks(arg0: string): Promise<Array<FileChunk>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFileChunks(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyUploads(): Promise<Array<FileMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyUploads();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalUploads(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalUploads();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserUploadCount(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserUploadCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isFileShared(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isFileShared(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async shareFile(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.shareFile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadChunk(arg0: string, arg1: FileChunk): Promise<void> {
        if (this.processError) {
            try {
    ...
    async uploadFileMetadata(arg0: string, arg1: string, arg2: bigint, arg3: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFileMetadata(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ChunkInfo]): ChunkInfo | null {
    return value.length === 0 ? null : value[0];
}
